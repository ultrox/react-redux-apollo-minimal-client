  ...
  render() {
    ...
    return (
      <ListItem className={classes.item}>
        ...
        <Typography variant="subheading" className={classes.loop}>
          Loop: {timer.loop}
        </Typography>
        ...
        <Typography className={[classes.timeStart, classes.pos].join(" ")}>
          {timer.start}
        </Typography>
        <Typography className={[classes.timeEnd, classes.pos].join(" ")}>
          {timer.end}
        </Typography>
        ...
        <Typography variant="subheading" className={classes.actionStack}>
